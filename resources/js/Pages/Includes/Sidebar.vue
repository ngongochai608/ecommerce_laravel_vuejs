<template>
    <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-[208px] h-screen pt-8 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        <Link :href="route('dashboard')" class="flex items-center px-1 mb-5">
            <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">E-commerce Store</span>
        </Link>
